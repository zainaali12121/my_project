...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
    HAL_GPIO_TogglePin(GPIOE, GPIO_PIN_8);  // Toggle LED
    delay_ms(1000); 
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12|GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2, GPIO_PIN_RESET);
